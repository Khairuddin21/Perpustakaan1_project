        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="content-area">
                ...
                <div class="stats-grid">
                    <div class="stat-card primary">
                        ...
                        <div class="stat-info">
                            ...
                            <div class="stat-value">{{ $borrowedBooks->where('status','borrowed')->count() }}</div>
                        </div>
                    </div>
                    <div class="stat-card danger">
                        ...
                        <div class="stat-info">
                            ...
                            <div class="stat-value">{{ $borrowedBooks->where('status','overdue')->count() }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <form class="search-form" action="{{ route('user.returns') }}" method="GET">
                        <input type="text" name="search" class="search-input" placeholder="Cari judul buku atau ISBN..." value="{{ request('search') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="status-badge {{ $loan->status }}">
                                                <i class="fas {{ $loan->status === 'overdue' ? 'fa-exclamation-triangle' : 'fa-check-circle' }}"></i>
