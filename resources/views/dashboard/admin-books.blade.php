...
<head>
    ...
    <title>Kelola Buku - {{ config('app.name', 'Sistem Perpustakaan') }}</title>
    ...
    <div class="books-management-container">
            ...
            <form method="GET" action="{{ route('admin.books.index') }}" id="filterForm">
                <div class="filter-grid">
                    <div class="filter-group">
                        ...
                        <input type="text" name="search" class="filter-input" placeholder="Judul, penulis, ISBN, atau penerbit..." value="{{ request('search') }}">
                    </div>
                    <div class="filter-group">
                        <label class="filter-label">
                    ...
                    <div class="filter-group">
                        ...
                        <select name="sort" class="filter-select">
                            ...
                            <option value="published_year" {{ request('sort') == 'published_year' ? 'selected' : '' }}>Tahun Terbit</option>
                        </select>
                    </div>
                ...
                @foreach($books as $book)
                    <div class="book-card">
                        <div class="book-cover">
                            <img src="{{ asset($book->cover_image ?? 'Gambar/default-book.jpg') }}" alt="{{ $book->title }}">
                        ...
                        <div class="book-content">
                            ...
                            <div class="book-info">
                                <div class="book-info-item">
                                    ...
                                    <span class="book-info-value">{{ Str::limit($book->publisher, 15) }}</span>
                                </div>
                                <div class="book-info-item">
                                    <span class="book-info-label">Tahun</span>
                                    <span class="book-info-value">{{ $book->published_year }}</span>
                                </div>
                                <div class="book-info-item">
                                ...
                                <div class="book-info-item">
                                    ...
                                    <span class="book-info-value">{{ $book->stock }} / {{ $book->available }}</span>
                                </div>
                            </div>
            ...
            <div class="pagination-wrapper">
                ...
                <div class="pagination-controls">
                    ...
                    <div class="pagination-numbers">
                        ...
                        {{-- First Page --}}
                        @if($start > 1)
                            <a href="{{ $books->url(1) }}" class="pagination-number">1</a>
                            @if($start > 2)
                        ...
                        @for($i = $start; $i <= $end; $i++)
                            ...
                            @else
                                <a href="{{ $books->url($i) }}" class="pagination-number">{{ $i }}</a>
                            @endif
                        @endfor
                        ...
                        @if($end < $lastPage)
                            @if($end < $lastPage - 1)
                                <span class="pagination-dots">...</span>
                            @endif
                            <a href="{{ $books->url($lastPage) }}" class="pagination-number">{{ $lastPage }}</a>
                        @endif
                    </div>
        ...
        @else
            <div class="empty-state">
                ...
                <p>{{ request('search') ? 'Coba ubah kata kunci pencarian Anda' : 'Mulai tambahkan buku pertama Anda' }}</p>
            </div>
        @endif
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="published_year" id="published_year" class="form-input" placeholder="Tahun terbit" min="1900" max="{{ date('Y') + 1 }}" required>
                        </div>
                    </div>
