        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('books.browse')); ?>" class="nav-item active">
                ...
                <div class="nav-section">
                    ...
                    <a href="#" class="nav-item">
                        ...
                        <?php if(isset($active_loans) && $active_loans->count() > 0): ?>
                        <span class="notification-badge"><?php echo e($active_loans->count()); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="#" class="nav-item">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 1.5rem;" id="booksGrid">
                        ...
                        <div style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(20px); border-radius: 20px; overflow: hidden; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1); transition: all 0.3s ease; cursor: pointer; position: relative; border: 1px solid rgba(255, 255, 255, 0.2);" class="book-card fade-in" onmouseover="this.style.transform='translateY(-8px)'; this.style.boxShadow='0 16px 40px rgba(102, 126, 234, 0.2)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 8px 32px rgba(0, 0, 0, 0.1)'">
                            <div style="width: 100%; height: 300px; background: linear-gradient(135deg, var(--primary), var(--secondary)); display: flex; align-items: center; justify-content: center; color: white; font-size: 3rem; position: relative;">
                                <i class="fas fa-book"></i>
                                <span style="position: absolute; top: 1rem; right: 1rem; padding: 0.4rem 0.8rem; border-radius: 20px; font-size: 0.75rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; backdrop-filter: blur(10px); <?php echo e($book->available > 0 ? 'background: rgba(16, 185, 129, 0.2); color: #065f46; border: 1px solid rgba(16, 185, 129, 0.3);' : 'background: rgba(239, 68, 68, 0.2); color: #991b1b; border: 1px solid rgba(239, 68, 68, 0.3);'); ?>">
                                    <?php echo e($book->available > 0 ? 'Tersedia' : 'Tidak Tersedia'); ?>

                                </span>
                            </div>
                            <div style="padding: 1.5rem;">
                                <span style="color: var(--primary); font-size: 0.8rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 0.5rem; display: block;"><?php echo e($book->category->name ?? 'Umum'); ?></span>
                                <h3 style="font-size: 1.1rem; font-weight: 700; color: var(--text-dark); margin-bottom: 0.5rem; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;"><?php echo e($book->title); ?></h3>
                                <p style="color: var(--text-light); font-size: 0.9rem; margin-bottom: 1rem;"><?php echo e($book->author); ?></p>
                                ...
                                <div style="display: flex; gap: 0.5rem;">
                                    ...
                                    <button style="padding: 0.5rem 1rem; font-size: 0.8rem; background: linear-gradient(135deg, var(--primary), var(--secondary)); color: white; border: none; border-radius: 10px; cursor: pointer; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 0.5rem;" onclick="borrowBook(<?php echo e($book->id); ?>)" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 8px 25px rgba(102, 126, 234, 0.3)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='none'">
                                    ...
                                    <?php endif; ?>
                                    <button style="padding: 0.5rem 1rem; font-size: 0.8rem; background: transparent; color: var(--primary); border: 2px solid var(--primary); border-radius: 10px; cursor: pointer; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 0.5rem;" onclick="viewDetails(<?php echo e($book->id); ?>)" onmouseover="this.style.background='var(--primary)'; this.style.color='white'" onmouseout="this.style.background='transparent'; this.style.color='var(--primary)'">
