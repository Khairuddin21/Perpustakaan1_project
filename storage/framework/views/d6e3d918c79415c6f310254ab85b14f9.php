...
<head>
    ...
    <title>Laporan Peminjaman - <?php echo e(config('app.name', 'Sistem Perpustakaan')); ?></title>
...
<body>
                ...
                <div class="stats-summary">
                    <div class="summary-card total">
                        ...
                        <div class="summary-info">
                            <h3 class="summary-value" id="totalLoans"><?php echo e($summary['total'] ?? 0); ?></h3>
                    ...
                    <div class="summary-card borrowed">
                        ...
                        <div class="summary-info">
                            <h3 class="summary-value" id="borrowedLoans"><?php echo e($summary['borrowed'] ?? 0); ?></h3>
                    ...
                    <div class="summary-card returned">
                        ...
                        <div class="summary-info">
                            <h3 class="summary-value" id="returnedLoans"><?php echo e($summary['returned'] ?? 0); ?></h3>
                    ...
                    <div class="summary-card overdue">
                        ...
                        <div class="summary-info">
                            <h3 class="summary-value" id="overdueLoans"><?php echo e($summary['overdue'] ?? 0); ?></h3>
    ...
    <script>
        ...
        ?>
        const chartData = <?php echo json_encode($chartDataJson, 15, 512) ?>;
        ...
        document.getElementById('filterForm').addEventListener('submit', function(e) {
            ...
            window.location.href = `<?php echo e(route('admin.reports')); ?>?${params.toString()}`;
        });
        ...
        function downloadExcel() {
            ...
            window.location.href = `<?php echo e(route('admin.reports.download.excel')); ?>?${params.toString()}`;
        }
...
<?php /**PATH C:\xampp\htdocs\Perpustakaan1_project\resources\views/dashboard/reports.blade.php ENDPATH**/ ?>